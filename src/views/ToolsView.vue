...
export default {
  ...
  mounted() {
    fetch('https://raw.githubusercontent.com/tsgscraft/tsgscraft.com-files/refs/heads/main/tools.json')
        .then(response => {
          if (!response.ok) {
...
<style scoped>
body {
  background-image: url('/src/assets/pictures/minecraft2.jpeg');
